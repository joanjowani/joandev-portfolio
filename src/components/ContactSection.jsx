...
export const ContactSection = () => {
  ...
  const handleSubmit = (e) => {
    ...
    }).catch(() => alert("An error occurred while sending the message. Please try again later."));
  ...
  <div className="flex flex-col items-center justify-start h-full">
    ...
    <div className="flex items-center space-x-10">
      ...
      >
        ...
        <div className="mt-12 bg-card p-8 rounded-lg shadow-xs" onSubmit={handleSubmit}>
